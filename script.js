...
console.log("Área de rectángulo: " + calcularAreaRectangulo(5, 10));
console.log("Área de rectángulo: " + calcularAreaRectangulo(6, 8));
console.log("Área de rectángulo: " + calcularAreaRectangulo(3, 1));